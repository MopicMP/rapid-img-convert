...
> Rapid convert images between formats

[![PyPI version](https://badge.fury.io/py/rapid-img-convert.svg)](https://pypi.org/project/rapid-img-convert/)
...
```bash
pip install rapid-img-convert
```

## Quick Start

```python
from rapid_img_convert import convert
...
from rapid_img_convert import batch
